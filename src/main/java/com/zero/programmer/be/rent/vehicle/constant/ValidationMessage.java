...
public final class ValidationMessage {
    ...
    public static final String IS_ACTIVE_REQUIRED = "Is Active Required | Status Aktif Tidak Boleh Kosong";
    public static final String API_KEY_REQUIRED = "Api Key Is Required | Api Key Tidak Boleh Kosong";
}
